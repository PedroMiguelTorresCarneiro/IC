...
public:
    ...
    // ----------------------------------------------- Create a frequency table for the image
    std::map<int, int> createFrequencyTable(const cv::Mat& image);

    // ----------------------------------------------- Convert the image to grayscale
    cv::Mat convertToGrayscale(const std::vector<cv::Mat>& channels);

    // ----------------------------------------------- Convert the grayscale image to color
    cv::Mat convertToColor(const cv::Mat& grayscaleImage);

    // ----------------------------------------------- Convert the grayscale image to color channels
    std::vector<cv::Mat> convertToColorChannels(const cv::Mat& grayscaleImage);
